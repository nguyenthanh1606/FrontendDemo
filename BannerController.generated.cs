...
namespace Frontend.Controllers
{
    public partial class BannerController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string Display = "Display";
                public readonly string SlideProd = "SlideProd";
                public readonly string StaticImageOnly = "StaticImageOnly";
            }
            public readonly string Display = "~/Views/Banner/Display.cshtml";
            public readonly string SlideProd = "~/Views/Banner/SlideProd.cshtml";
            public readonly string StaticImageOnly = "~/Views/Banner/StaticImageOnly.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BannerController : Frontend.Controllers.BannerController
    {
        public T4MVC_BannerController() : base(Dummy.Instance) { }

        [NonAction]
        partial void DisplayOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int position, int? countItem, string viewName);

        [NonAction]
        public override System.Web.Mvc.ActionResult Display(int position, int? countItem, string viewName)
        {
            ...
            DisplayOverride(callInfo, position, countItem, viewName);
            return callInfo;
        }
